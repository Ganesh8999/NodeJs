  ...
  Product.find()
    ...
    .then((products) => {
      res.render("shop/product-list", {
        ...
        path: "/products",
        currentPage: page,
        hasNextPage: PRODUCTS_PER_PAGE * page < noOfDocuments,
        hasPreviousPage: page > 1,
        nextPage: page + 1,
        previousPage: page - 1,
        lastPage: Math.ceil(noOfDocuments / PRODUCTS_PER_PAGE),
      });
    })
    .catch((err) => {
...
exports.getInvoice = (req, res, next) => {
  ...
  Order.findById(invoiceId)
    .then((order) => {
      ...
      // This is much better way if we are having big file size
